...
var tax = price + (price * 6 / 100); //declares variable and defines tax value of 6% from the totalPrice

var finalPrice = totalPrice + tax; //declares variable and defines finalPrice as totalPrice + tax
var finalPriceDo = " The total price of each cabinet  is $" + price + "and with sales tax included is $" + finalPrice; //declares variable and it shows the result in the setence
